...
<template>
  <div class="max-w-xl">
    ...
    <div v-if="loadingItem" class="text-center py-8 text-muted-foreground">
      {{ t('FOOD_FORM.LOADING') }}
    </div>

    <form v-else @submit.prevent="handleSubmit">
      <fieldset class="border border-border rounded-lg p-5 mb-6">
        <legend class="font-semibold text-sm text-foreground px-2">
          {{ t('FOOD_FORM.SECTION_INFO') }}
        </legend>
        ...
        <div class="mb-4">
          ...
          <Input
            ...
            v-model="name"
            type="text"
            :placeholder="t('FOOD_FORM.NAME_PLACEHOLDER')"
            required
            class="mt-1"
          />
        </div>
        ...
        <div class="flex gap-4">
          <div class="mb-4 flex-1">
            ...
            <Input
              ...
              v-model="brand"
              type="text"
              :placeholder="t('FOOD_FORM.BRAND_PLACEHOLDER')"
              class="mt-1"
            />
          </div>
          <div class="mb-4 flex-1">
            ...
            <Input
              ...
              v-model="defaultUnit"
              type="text"
              :placeholder="t('FOOD_FORM.DEFAULT_UNIT_PLACEHOLDER')"
              required
              class="mt-1"
            />
          </div>
        ...
        <div class="flex gap-4">
          ...
          <div class="mb-4 flex-1">
            ...
            <Input
              ...
              v-model="basisUnit"
              type="text"
              :placeholder="t('FOOD_FORM.BASIS_UNIT_PLACEHOLDER')"
              required
              class="mt-1"
            />
          </div>
