...
Devise.setup do |config|
  ...
  # config.secret_key = '983e3020aa9ade90d7fd5a3a5de9bcefcd27173228c0291269abbc04d6dbea8f93bd99792ee8c6aeab5e7320e7fcf78b1737ba8e3468f3544c228dd2b6739525'
  ...
  config.mailer_sender = ENV.fetch("RESEND_FROM_EMAIL", "noreply@dailyhealth.com")
  ...
  # config.pepper = 'a6ed52d24fbb01b71a9ce0ceba104b357eda0894062d9057b691aaf6b4187a226eaafcbee2479528f36a305479179580bc363dd03b7b7c7db847b89a52fe696f'
  ...
  # For a pure JSON API (no HTML views), set to [] so Devise never redirects to HTML forms.
